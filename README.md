...
1. RwLock<> allows multiple readers or one writer at a time, which is useful when you have a data structure that is read often but written to infrequently. 
